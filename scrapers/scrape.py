...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(__file__), "..", "scrapers_output")
    ...
    time.sleep(1)
    all_checkbox = driver.find_element(By.NAME, \
                "FI_sqlproxy.1j0k1xa05f9b0k18gqber1rlouv3,none:INSTRUCTOR_NAME:nk7413426041701531777_11695660129199681370_(All)")
    all_checkbox.click()
        ...
        while True:
            try:
                ...
                checkbox = driver.find_element(
                    By.XPATH, f'//a[contains(text(), "{name}")]/preceding-sibling::input'
                )
                time.sleep(5)
                ...
                body = driver.find_element(
                    By.XPATH, '//div[@class="tab-glass clear-glass tab-widget"]'
                )
                time.sleep(3)
                body.click()
                time.sleep(0.5)
                ...
                incorrect_element = driver.find_element(
                    By.XPATH, '//span[contains(text(), "'+"%"+' of Total Count of RESPONSE_VALUE along RESPONSE_CATEGORY:")" and @style="font-family:\'Tableau Book\';font-size:13px;color:#787878;font-weight:normal;font-style:normal;text-decoration:none;"]'
                    )
                ...
                with open(os.path.join(output_dir, "broken_names.txt"), 'a') as f_object:
